        ...
        <div className="flex flex-col lg:flex-row gap-20 lg:gap-32 items-start">
          ...
          >
            <div className="flex flex-col items-start mb-10">
              <span className="text-sm font-sans uppercase tracking-[0.4em] text-comm-terracotta mb-6">Write your chapter</span>
              <div className="w-12 h-px bg-comm-terracotta/30 mb-10"></div>
            </div>
            <h1 className="text-4xl md:text-7xl font-serif text-ink mb-8 md:mb-10 leading-tight">Join the <br /><span className="italic text-comm-terracotta font-normal">Mission</span></h1>
            
            <p className="text-lg md:text-xl text-ink/70 mb-10 md:mb-12 leading-relaxed font-serif italic">
            ...
            <div className="bg-white/40 backdrop-blur-sm rounded-[2rem] md:rounded-[2.5rem] p-8 md:p-12 border border-muted/50 paper-shadow mb-12 relative overflow-hidden group">
              {/* Subtle motif */}
              ...
              <ul className="space-y-8">
                <li className="flex items-start">
                  <div className="w-2 h-2 rounded-full bg-edu-orange mt-2 mr-4 shrink-0"></div>
                  <span className="text-ink/60 font-sans italic">Make a direct, measurable impact on rural lives.</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 rounded-full bg-comm-terracotta mt-2 mr-4 shrink-0"></div>
                  <span className="text-ink/60 font-sans italic">Gain hands-on experience in community development.</span>
                </li>
                <li className="flex items-start">
                  <div className="w-2 h-2 rounded-full bg-inno-cyan mt-2 mr-4 shrink-0"></div>
          ...
          <motion.div 
            className="w-full lg:w-[550px] bg-white/60 backdrop-blur-md rounded-[2rem] md:rounded-[3rem] p-8 md:p-14 shadow-2xl border border-muted/30 paper-shadow relative"
            initial={{ opacity: 0, x: 30 }}
            animate={{ opacity: 1, x: 0 }}
